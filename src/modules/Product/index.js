          ...
          <img alt={product?.title} className="lg:w-1/2 w-full lg:h-auto max-h-[600px] h-64 object-contain object-center rounded" src={product?.image}/>
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className='flex'>
                <button className="flex ml-auto text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded mr-2">Buy it now</button>
                <button className="flex ml-auto border border-green-500 py-2 px-6 focus:outline-none hover:bg-green-600 hover:text-white rounded">Add To Cart</button>
                </div>

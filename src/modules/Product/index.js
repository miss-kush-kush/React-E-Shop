        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className='flex'>
                <button className="flex ml-auto text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded mr-2" onClick={() => handleCart(product, true)}>Buy it now</button>
                <button className="flex ml-auto border border-green-500 py-2 px-6 focus:outline-none hover:bg-green-600 hover:text-white rounded" onClick={() => handleCart(product)}>
                  Add To Cart</button>
              </div>
